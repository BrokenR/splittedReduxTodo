...
function Task({ id, description, listId, done, onComplete, onDelete, onEdit }) {
  ...
  return (
    <li>
      {!visiblePopUp?(
          <React.Fragment>
            <div className="checkbox">
              <input
                  ...
                  onChange={isSet}
                  type="checkbox"
                  id={`task_${id}_${description}`}
                  checked={done}
              />
              <label htmlFor={`task_${id}_${description}`}>
                <svg
                    width="11"
                    height="8"
                    viewBox="0 0 11 8"
            ...
            <button className="btn_edit" onClick={()=>setVisiblePopUp(!visiblePopUp)}>
              <svg
                  width="15"
                  height="15"
                  viewBox="0 0 15 15"
            ...
            <button onClick={deleteTask} className="btn_remove">
              <svg
                  width="11"
                  height="11"
                  viewBox="0 0 11 11"
          ...
          </React.Fragment>):<div className='popup__form'>
        <input
        ...
        />
        <button className="btn_edit" onClick={editTask}>
          <svg
              width="11"
              height="8"
              viewBox="0 0 11 8"
        ...
        <button className='btn_remove' onClick={()=>cancelEdit()}>
          <svg
              width="11"
              height="11"
              viewBox="0 0 11 11"
